                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            @if($products)
                                @foreach($products as $product)
                                    <div class="arrivals_slider_item col col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                                        <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img width="120" src="{{asset('catalog/'.config('app.template'))}}/{{\App\Models\ProductImage::getCoverImage($product->id)}}" alt="{{$product->name}}"></div>
                                ...
                                @endforeach
                            @else
                                <p class="col-md-12 text-center">Nenhum produto cadastrado nesta categoria.</p>
                            @endif
                        </div>
                    </div>
