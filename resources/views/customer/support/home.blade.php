        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <a href="{{route('customer-support-create')}}" class="btn btn-sm bg-aqua margin-r-5"><i class="fa fa-plus"></i> Novo Chamado de Suporte</a>
                </div>
...
@push('scripts')
    <script>
        $('#supports-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{route('datatable-customer-supports')}}',
            columns: [
