            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <a href="{{route('customer-supports')}}" onclick="localStorage.clear();" class="btn btn-sm bg-aqua margin-r-5 btn-flat"><i class="fa fa-list"></i> Listagem de Chamados de Suporte</a>
                        <a href="{{route('customer-support-close', [base64_encode($support->id)])}}" class="btn btn-sm bg-red btn-flat" ><i class="fa fa-check-circle"></i> Fechar Chamado</a>
                    </div>
                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="singletabs">
                                            @include('customer.support.partials.show')
                                        </div>
                                    </div>
                                </div>
                            </div>
