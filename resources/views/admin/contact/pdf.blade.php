        ...
        <section class="invoice">
            <div class="invoice-header">
                ...
                <div class="row invoice-info">
                    ...
                    <!-- /.col -->
                    <div class="col-sm-4 invoice-col">
                        <strong>Orçamento: #COD{{$data->id}}</strong><br>
                        <br>
            ...
            <div class="row">
                <div class="col-xs-12 table-responsive">
                    <table class="table" cellpadding="0" cellspacing="0">
                        <thead>
                        <tr>
                            <th colspan="1" class="text-center border-top bg-gray">ID</th>
                            <th colspan="2" class="text-center border-top bg-gray">NOME DO PRODUTO</th>
