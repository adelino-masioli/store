            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered table-condensed table-hover table-striped" id="configurations-table" style="width: 100%;">
                                <thead>
                                <tr>
                                    <th class="hidden-xs col-md-1 text-center">ID</th>
                                    <th class="hidden-xs col-md-1 text-center">AÇÃO</th>
                                    <th class="col-md-4 text-center">DESCRIÇÃO</th>
                                    <th class="col-md-2 text-center">CONTATO</th>
...
@push('scripts')
    <script>
        $('#configurations-table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{route('datatable-configurations')}}',
            columns: [
