                    ...
                    <div class="timeline-item">
                        ...
                        @if($support->file)
                            <div class="timeline-footer">
                                <a href="{{route('support-download', base64_encode($support->file))}}" class="btn btn-default btn-xs btn-flat"><i class="fa fa-download"></i> Baixar arquivo</a>
                            </div>
                        @endif
                    </div>
                </li>
                    ...
                    @foreach($support_answers as $support_answer)
                        ...
                        <li>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-footer">
                                    <a href="{{route('support-download', base64_encode($support_answer->file))}}" class="btn btn-default btn-xs btn-flat"><i class="fa fa-download"></i> Baixar arquivo</a>
                                </div>
                                @endif
                            </div>
                        </li>
   ...
   @if($support->status_id != statusOrder('closed'))
    <div class="row no-print" style="margin-top: 30px;">
        <div class="col-xs-12">
            ...
            <form action="{{route('support-answer')}}" method="post" class="panels" id="formsubmit" enctype="multipart/form-data">
            {{ csrf_field() }}
