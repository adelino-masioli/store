...
@endif
<a href="{{route('order-next-payment-confirm', [base64_encode($order->id)])}}" class="btn btn-sm bg-yellow btn-flat pull-right">Confirmar pedido e finalizar <i class="fa fa-check-circle" aria-hidden="true"></i></a>
