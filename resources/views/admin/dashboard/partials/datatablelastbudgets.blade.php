<div class="col-md-4">
    <div class="box box-primary box-dash" style="height: calc(100vh - 290px);overflow:hidden; margin-bottom: 0px;">
        <div class="box-header with-border">
            <h3 class="box-title">Orçamentos enviados <a href="#" class="pull-right text-primary"><i class="fa fa-plus-circle text-primary"></i> NOVO</a></h3>
        </div>
