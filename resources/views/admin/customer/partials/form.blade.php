            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="cellphone" name="cellphone" onkeypress="maskCellphone('#cellphone');" placeholder="Celular/WhatsApp" value="@if(isset($user_complemento)){{$user_complemento->cellphone}}@else{{old('cellphone')}}@endif">
                    </div>
                </div>
            </div>
        </div>
