...
@component('admin.components.contentheader')
    ...
    @endslot
    @slot('small')
        Listagem de Pedidos para expedição
    @endslot
    @slot('link')
        Pedidos para expedição
    @endslot
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered table-condensed table-hover table-striped" id="datatable-orders-expedition" style="width: 100%;">
                                <thead>
                                <tr>
...
@push('scripts')
    <script>
        var table =  $('#datatable-orders-expedition').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{route('datatable-orders-expedition')}}',
            columns: [
