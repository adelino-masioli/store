                ...
                <tr><!-- modulo row logo -->
                    <td valign="top" class="logo" bgcolor="#ffffff" style="" height="60" align="center">
                        <table align="center" border="0" cellpadding="20" cellspacing="0">
                            <tr>
                                <td>
                                    <a href="https://www.coopcompras.com.br" target="_blank" style="text-decoration: none;" title="">
                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="" style="border-spacing:0;border-collapse:collapse">
                                        ...
                                        <!--dados do cliente!-->
                                        <tr>
                                            <td colspan="4" align="center" class="h2" style="padding: 5px 0 0 0;">
                                                <h3>Olá {{ $user->name }}</h3>
                                        ...
                                        <tr>
                                            <td>
                                                <p>A partir de agora você está cadastrado para utilizar o sistema.</p>
                                                <p>Clique <a href="{{url('/activate/account')}}/{{$user->active_token}}">aqui</a> para ativar sua conta.</p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
