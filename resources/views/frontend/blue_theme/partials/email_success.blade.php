<div class="row register-form">
    <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-8 offset-lg-2" data-aos="fade-right" data-aos-delay="50" data-aos-easing="ease-in-out">
        ...
        <h1 class="title-internal-page">
            Solicitação recebida com sucesso. Favor acessar seu email para alterar sua senha.
        </h1>
        ...
        <p class="text-center">Se preferir não alterar seua senha agora, clique <a href="{{route('frontend-home')}}">aqui</a>  e continue navegando no site.</p>
