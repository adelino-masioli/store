<div class="row register-form">
    ...
    <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-5" data-aos="fade-right" data-aos-delay="50" data-aos-easing="ease-in-out">
        <h1 class="login-title col-xs-12 col-sm-12 col-md-8 offset-md-4 col-lg-9 offset-lg-3">Já tenho uma conta</h1>
        ...
        <form action="{{route('frontend-login-post')}}" method="post">
            ...
            <div class="form-group row">
                <div class="col-xs-12 col-sm-12 col-md-8 offset-md-4 col-lg-9 offset-lg-3">
                    <button class="btn btn-success btn-flat btn-login" type="submit">ENTRAR</button>
