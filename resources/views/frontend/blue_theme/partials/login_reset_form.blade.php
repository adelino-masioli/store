<div class="row register-form">
    ...
    <div class="col col-xs-12 col-sm-12 col-md-12 col-lg-5" data-aos="fade-right" data-aos-delay="50" data-aos-easing="ease-in-out">
        <h1 class="login-title col-xs-12 col-sm-12 col-md-8 offset-md-4 col-lg-9 offset-lg-3">Alterar senha</h1>

        <small class="text-info text-right">(*) Campos obrigatórios.</small>
        <form action="{{route('frontend-reset-my-password')}}" method="post">
            {{ csrf_field() }}
            ...
            <div class="form-group row">
                <label for="password" class="col col-xs-12 col-sm-4 col-md-4 col-lg-3 col-form-label text-right">Senha <span class="text-danger">*</span></label>
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
                    <input type="password" class="form-control" name="password" id="password" placeholder="Senha" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="password_confirmation" class="col col-xs-12 col-sm-4 col-md-4 col-lg-3 col-form-label text-right">Confirmar <span class="text-danger">*</span></label>
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9">
            ...
            <div class="form-group row">
                <div class="col-xs-12 col-sm-12 col-md-8 offset-md-4 col-lg-9 offset-lg-3">
                    <button class="btn btn-success btn-flat btn-login" type="submit">ALTERAR SENHA</button>
