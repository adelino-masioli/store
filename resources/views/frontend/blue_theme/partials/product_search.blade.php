<div class="container product-list">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9 products-list">
            @if($products->total() == 0)
                <h1 class="text-center">Sua busca não retornou nenhum produto.</h1>
                <h6 class="text-center">Faça uma nova busca com outros refinamentos.</h6>
            ...
            @else
                <div class="row">
                    <div class="nav-product-list nav-product-list-top col-md-12">
                        ...
                        @component('frontend.blue_theme.components.filter', ['url'=>'frontend-product-result']) @endcomponent {{--component filter--}}
                    </div>
                </div>
