...
@section('title', $config_site->name .' - Socilicação de alteração de senha efetuada com sucesso' )
...
@section('content')
    ...
    <div class="container internal-pages">
        @component('frontend.blue_theme.components.breadcrumb')
            <li class="breadcrumb-item active" aria-current="page">Socilicação de alteração de senha efetuada com sucesso</li>
        @endcomponent {{--component breadcrumb--}}

        @include('frontend.blue_theme.partials.email_success')<!-- register form-->
    </div>
